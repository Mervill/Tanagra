...
namespace Vulkan.Interop
{
    internal unsafe static class VK
    {
        ...
        internal static extern PFN_vkVoidFunction vkGetDeviceProcAddr(IntPtr device, Char* name);
        
        [DllImport(DllName, EntryPoint = "vkGetInstanceProcAddr", CallingConvention = CallingConvention.Winapi)]
        internal static extern PFN_vkVoidFunction vkGetInstanceProcAddr(IntPtr instance, Char* name);
        ...
        internal static extern Result vkEnumerateInstanceExtensionProperties(Char* layerName, UInt32* propertyCount, ExtensionProperties* properties);
        ...
        internal static extern Result vkEnumerateDeviceExtensionProperties(IntPtr physicalDevice, Char* layerName, UInt32* propertyCount, ExtensionProperties* properties);
        ...
        internal static extern Result vkGetPipelineCacheData(IntPtr device, IntPtr pipelineCache, UIntPtr* dataSize, IntPtr* data);
        ...
        internal static extern Result vkGetPhysicalDeviceSurfacePresentModesKHR(IntPtr physicalDevice, IntPtr surface, UInt32* presentModeCount, PresentModeKHR* presentModes);
        ...
        internal static extern void vkDebugReportMessageEXT(IntPtr instance, VkDebugReportFlagsEXT flags, DebugReportObjectTypeEXT objectType, UInt64 @object, UIntPtr location, Int32 messageCode, Char* layerPrefix, Char* message);
