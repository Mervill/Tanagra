...
namespace Vulkan.Interop
{
    internal unsafe static class VK
    {
        ...
        internal static extern Result vkQueueSubmit(IntPtr queue, UInt32 submitCount, SubmitInfo* submits, UInt64 fence);
        ...
        internal static extern Result vkAllocateMemory(IntPtr device, MemoryAllocateInfo* allocateInfo, AllocationCallbacks* allocator, UInt64* memory);
        
        [DllImport(DllName, EntryPoint = "vkFreeMemory", CallingConvention = callingConvention)]
        internal static extern void vkFreeMemory(IntPtr device, UInt64 memory, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkMapMemory", CallingConvention = callingConvention)]
        internal static extern Result vkMapMemory(IntPtr device, UInt64 memory, DeviceSize offset, DeviceSize size, MemoryMapFlags flags, IntPtr* data);
        
        [DllImport(DllName, EntryPoint = "vkUnmapMemory", CallingConvention = callingConvention)]
        internal static extern void vkUnmapMemory(IntPtr device, UInt64 memory);
        ...
        internal static extern void vkGetDeviceMemoryCommitment(IntPtr device, UInt64 memory, DeviceSize* committedMemoryInBytes);
        
        [DllImport(DllName, EntryPoint = "vkGetBufferMemoryRequirements", CallingConvention = callingConvention)]
        internal static extern void vkGetBufferMemoryRequirements(IntPtr device, UInt64 buffer, MemoryRequirements* memoryRequirements);
        
        [DllImport(DllName, EntryPoint = "vkBindBufferMemory", CallingConvention = callingConvention)]
        internal static extern Result vkBindBufferMemory(IntPtr device, UInt64 buffer, UInt64 memory, DeviceSize memoryOffset);
        
        [DllImport(DllName, EntryPoint = "vkGetImageMemoryRequirements", CallingConvention = callingConvention)]
        internal static extern void vkGetImageMemoryRequirements(IntPtr device, UInt64 image, MemoryRequirements* memoryRequirements);
        
        [DllImport(DllName, EntryPoint = "vkBindImageMemory", CallingConvention = callingConvention)]
        internal static extern Result vkBindImageMemory(IntPtr device, UInt64 image, UInt64 memory, DeviceSize memoryOffset);
        
        [DllImport(DllName, EntryPoint = "vkGetImageSparseMemoryRequirements", CallingConvention = callingConvention)]
        internal static extern void vkGetImageSparseMemoryRequirements(IntPtr device, UInt64 image, UInt32* sparseMemoryRequirementCount, SparseImageMemoryRequirements* sparseMemoryRequirements);
        ...
        internal static extern Result vkQueueBindSparse(IntPtr queue, UInt32 bindInfoCount, BindSparseInfo* bindInfo, UInt64 fence);
        
        [DllImport(DllName, EntryPoint = "vkCreateFence", CallingConvention = callingConvention)]
        internal static extern Result vkCreateFence(IntPtr device, FenceCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* fence);
        
        [DllImport(DllName, EntryPoint = "vkDestroyFence", CallingConvention = callingConvention)]
        internal static extern void vkDestroyFence(IntPtr device, UInt64 fence, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkResetFences", CallingConvention = callingConvention)]
        internal static extern Result vkResetFences(IntPtr device, UInt32 fenceCount, UInt64* fences);
        ...
        internal static extern void vkDestroySemaphore(IntPtr device, UInt64 semaphore, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreateEvent", CallingConvention = callingConvention)]
        internal static extern Result vkCreateEvent(IntPtr device, EventCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* @event);
        
        [DllImport(DllName, EntryPoint = "vkDestroyEvent", CallingConvention = callingConvention)]
        internal static extern void vkDestroyEvent(IntPtr device, UInt64 @event, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkGetEventStatus", CallingConvention = callingConvention)]
        internal static extern Result vkGetEventStatus(IntPtr device, UInt64 @event);
        
        [DllImport(DllName, EntryPoint = "vkSetEvent", CallingConvention = callingConvention)]
        internal static extern Result vkSetEvent(IntPtr device, UInt64 @event);
        
        [DllImport(DllName, EntryPoint = "vkResetEvent", CallingConvention = callingConvention)]
        internal static extern Result vkResetEvent(IntPtr device, UInt64 @event);
        
        [DllImport(DllName, EntryPoint = "vkCreateQueryPool", CallingConvention = callingConvention)]
        internal static extern Result vkCreateQueryPool(IntPtr device, QueryPoolCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* queryPool);
        ...
        internal static extern void vkDestroyBuffer(IntPtr device, UInt64 buffer, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreateBufferView", CallingConvention = callingConvention)]
        internal static extern Result vkCreateBufferView(IntPtr device, BufferViewCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* view);
        
        [DllImport(DllName, EntryPoint = "vkDestroyBufferView", CallingConvention = callingConvention)]
        internal static extern void vkDestroyBufferView(IntPtr device, UInt64 bufferView, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreateImage", CallingConvention = callingConvention)]
        internal static extern Result vkCreateImage(IntPtr device, ImageCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* image);
        
        [DllImport(DllName, EntryPoint = "vkDestroyImage", CallingConvention = callingConvention)]
        internal static extern void vkDestroyImage(IntPtr device, UInt64 image, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkGetImageSubresourceLayout", CallingConvention = callingConvention)]
        internal static extern void vkGetImageSubresourceLayout(IntPtr device, UInt64 image, ImageSubresource* subresource, SubresourceLayout* layout);
        
        [DllImport(DllName, EntryPoint = "vkCreateImageView", CallingConvention = callingConvention)]
        internal static extern Result vkCreateImageView(IntPtr device, ImageViewCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* view);
        
        [DllImport(DllName, EntryPoint = "vkDestroyImageView", CallingConvention = callingConvention)]
        internal static extern void vkDestroyImageView(IntPtr device, UInt64 imageView, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreateShaderModule", CallingConvention = callingConvention)]
        internal static extern Result vkCreateShaderModule(IntPtr device, ShaderModuleCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* shaderModule);
        
        [DllImport(DllName, EntryPoint = "vkDestroyShaderModule", CallingConvention = callingConvention)]
        internal static extern void vkDestroyShaderModule(IntPtr device, UInt64 shaderModule, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreatePipelineCache", CallingConvention = callingConvention)]
        internal static extern Result vkCreatePipelineCache(IntPtr device, PipelineCacheCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* pipelineCache);
        ...
        internal static extern Result vkCreateGraphicsPipelines(IntPtr device, UInt64 pipelineCache, UInt32 createInfoCount, GraphicsPipelineCreateInfo* createInfos, AllocationCallbacks* allocator, UInt64* pipelines);
        
        [DllImport(DllName, EntryPoint = "vkCreateComputePipelines", CallingConvention = callingConvention)]
        internal static extern Result vkCreateComputePipelines(IntPtr device, UInt64 pipelineCache, UInt32 createInfoCount, ComputePipelineCreateInfo* createInfos, AllocationCallbacks* allocator, UInt64* pipelines);
        
        [DllImport(DllName, EntryPoint = "vkDestroyPipeline", CallingConvention = callingConvention)]
        internal static extern void vkDestroyPipeline(IntPtr device, UInt64 pipeline, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreatePipelineLayout", CallingConvention = callingConvention)]
        internal static extern Result vkCreatePipelineLayout(IntPtr device, PipelineLayoutCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* pipelineLayout);
        
        [DllImport(DllName, EntryPoint = "vkDestroyPipelineLayout", CallingConvention = callingConvention)]
        internal static extern void vkDestroyPipelineLayout(IntPtr device, UInt64 pipelineLayout, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreateSampler", CallingConvention = callingConvention)]
        internal static extern Result vkCreateSampler(IntPtr device, SamplerCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* sampler);
        
        [DllImport(DllName, EntryPoint = "vkDestroySampler", CallingConvention = callingConvention)]
        internal static extern void vkDestroySampler(IntPtr device, UInt64 sampler, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreateDescriptorSetLayout", CallingConvention = callingConvention)]
        internal static extern Result vkCreateDescriptorSetLayout(IntPtr device, DescriptorSetLayoutCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* setLayout);
        
        [DllImport(DllName, EntryPoint = "vkDestroyDescriptorSetLayout", CallingConvention = callingConvention)]
        internal static extern void vkDestroyDescriptorSetLayout(IntPtr device, UInt64 descriptorSetLayout, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreateDescriptorPool", CallingConvention = callingConvention)]
        internal static extern Result vkCreateDescriptorPool(IntPtr device, DescriptorPoolCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* descriptorPool);
        
        [DllImport(DllName, EntryPoint = "vkDestroyDescriptorPool", CallingConvention = callingConvention)]
        internal static extern void vkDestroyDescriptorPool(IntPtr device, UInt64 descriptorPool, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkResetDescriptorPool", CallingConvention = callingConvention)]
        internal static extern Result vkResetDescriptorPool(IntPtr device, UInt64 descriptorPool, DescriptorPoolResetFlags flags);
        
        [DllImport(DllName, EntryPoint = "vkAllocateDescriptorSets", CallingConvention = callingConvention)]
        internal static extern Result vkAllocateDescriptorSets(IntPtr device, DescriptorSetAllocateInfo* allocateInfo, UInt64* descriptorSets);
        
        [DllImport(DllName, EntryPoint = "vkFreeDescriptorSets", CallingConvention = callingConvention)]
        internal static extern Result vkFreeDescriptorSets(IntPtr device, UInt64 descriptorPool, UInt32 descriptorSetCount, UInt64* descriptorSets);
        ...
        internal static extern Result vkCreateFramebuffer(IntPtr device, FramebufferCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* framebuffer);
        
        [DllImport(DllName, EntryPoint = "vkDestroyFramebuffer", CallingConvention = callingConvention)]
        internal static extern void vkDestroyFramebuffer(IntPtr device, UInt64 framebuffer, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkCreateRenderPass", CallingConvention = callingConvention)]
        internal static extern Result vkCreateRenderPass(IntPtr device, RenderPassCreateInfo* createInfo, AllocationCallbacks* allocator, UInt64* renderPass);
        ...
        internal static extern void vkDestroyCommandPool(IntPtr device, UInt64 commandPool, AllocationCallbacks* allocator);
        
        [DllImport(DllName, EntryPoint = "vkResetCommandPool", CallingConvention = callingConvention)]
        internal static extern Result vkResetCommandPool(IntPtr device, UInt64 commandPool, CommandPoolResetFlags flags);
        ...
        internal static extern void vkFreeCommandBuffers(IntPtr device, UInt64 commandPool, UInt32 commandBufferCount, IntPtr* commandBuffers);
        ...
        internal static extern void vkCmdBindPipeline(IntPtr commandBuffer, PipelineBindPoint pipelineBindPoint, UInt64 pipeline);
        ...
        internal static extern void vkCmdBindDescriptorSets(IntPtr commandBuffer, PipelineBindPoint pipelineBindPoint, UInt64 layout, UInt32 firstSet, UInt32 descriptorSetCount, UInt64* descriptorSets, UInt32 dynamicOffsetCount, UInt32* dynamicOffsets);
        
        [DllImport(DllName, EntryPoint = "vkCmdBindIndexBuffer", CallingConvention = callingConvention)]
        internal static extern void vkCmdBindIndexBuffer(IntPtr commandBuffer, UInt64 buffer, DeviceSize offset, IndexType indexType);
        
        [DllImport(DllName, EntryPoint = "vkCmdBindVertexBuffers", CallingConvention = callingConvention)]
        internal static extern void vkCmdBindVertexBuffers(IntPtr commandBuffer, UInt32 firstBinding, UInt32 bindingCount, UInt64* buffers, DeviceSize* offsets);
        ...
        internal static extern void vkCmdDrawIndirect(IntPtr commandBuffer, UInt64 buffer, DeviceSize offset, UInt32 drawCount, UInt32 stride);
        
        [DllImport(DllName, EntryPoint = "vkCmdDrawIndexedIndirect", CallingConvention = callingConvention)]
        internal static extern void vkCmdDrawIndexedIndirect(IntPtr commandBuffer, UInt64 buffer, DeviceSize offset, UInt32 drawCount, UInt32 stride);
        ...
        internal static extern void vkCmdDispatchIndirect(IntPtr commandBuffer, UInt64 buffer, DeviceSize offset);
        
        [DllImport(DllName, EntryPoint = "vkCmdCopyBuffer", CallingConvention = callingConvention)]
        internal static extern void vkCmdCopyBuffer(IntPtr commandBuffer, UInt64 srcBuffer, UInt64 dstBuffer, UInt32 regionCount, BufferCopy* regions);
        
        [DllImport(DllName, EntryPoint = "vkCmdCopyImage", CallingConvention = callingConvention)]
        internal static extern void vkCmdCopyImage(IntPtr commandBuffer, UInt64 srcImage, ImageLayout srcImageLayout, UInt64 dstImage, ImageLayout dstImageLayout, UInt32 regionCount, ImageCopy* regions);
        
        [DllImport(DllName, EntryPoint = "vkCmdBlitImage", CallingConvention = callingConvention)]
        internal static extern void vkCmdBlitImage(IntPtr commandBuffer, UInt64 srcImage, ImageLayout srcImageLayout, UInt64 dstImage, ImageLayout dstImageLayout, UInt32 regionCount, ImageBlit* regions, Filter filter);
        
        [DllImport(DllName, EntryPoint = "vkCmdCopyBufferToImage", CallingConvention = callingConvention)]
        internal static extern void vkCmdCopyBufferToImage(IntPtr commandBuffer, UInt64 srcBuffer, UInt64 dstImage, ImageLayout dstImageLayout, UInt32 regionCount, BufferImageCopy* regions);
        ...
        internal static extern void vkCmdClearColorImage(IntPtr commandBuffer, UInt64 image, ImageLayout imageLayout, ClearColorValue* color, UInt32 rangeCount, ImageSubresourceRange* ranges);
        
        [DllImport(DllName, EntryPoint = "vkCmdClearDepthStencilImage", CallingConvention = callingConvention)]
        internal static extern void vkCmdClearDepthStencilImage(IntPtr commandBuffer, UInt64 image, ImageLayout imageLayout, ClearDepthStencilValue* depthStencil, UInt32 rangeCount, ImageSubresourceRange* ranges);
        ...
        internal static extern void vkCmdResolveImage(IntPtr commandBuffer, UInt64 srcImage, ImageLayout srcImageLayout, UInt64 dstImage, ImageLayout dstImageLayout, UInt32 regionCount, ImageResolve* regions);
        
        [DllImport(DllName, EntryPoint = "vkCmdSetEvent", CallingConvention = callingConvention)]
        internal static extern void vkCmdSetEvent(IntPtr commandBuffer, UInt64 @event, PipelineStageFlags stageMask);
        
        [DllImport(DllName, EntryPoint = "vkCmdResetEvent", CallingConvention = callingConvention)]
        internal static extern void vkCmdResetEvent(IntPtr commandBuffer, UInt64 @event, PipelineStageFlags stageMask);
        
        [DllImport(DllName, EntryPoint = "vkCmdWaitEvents", CallingConvention = callingConvention)]
        internal static extern void vkCmdWaitEvents(IntPtr commandBuffer, UInt32 eventCount, UInt64* events, PipelineStageFlags srcStageMask, PipelineStageFlags dstStageMask, UInt32 memoryBarrierCount, MemoryBarrier* memoryBarriers, UInt32 bufferMemoryBarrierCount, BufferMemoryBarrier* bufferMemoryBarriers, UInt32 imageMemoryBarrierCount, ImageMemoryBarrier* imageMemoryBarriers);
        ...
        internal static extern void vkCmdBeginQuery(IntPtr commandBuffer, UInt64 queryPool, UInt32 query, QueryControlFlags flags);
        
        [DllImport(DllName, EntryPoint = "vkCmdEndQuery", CallingConvention = callingConvention)]
        internal static extern void vkCmdEndQuery(IntPtr commandBuffer, UInt64 queryPool, UInt32 query);
        
        [DllImport(DllName, EntryPoint = "vkCmdResetQueryPool", CallingConvention = callingConvention)]
        internal static extern void vkCmdResetQueryPool(IntPtr commandBuffer, UInt64 queryPool, UInt32 firstQuery, UInt32 queryCount);
        
        [DllImport(DllName, EntryPoint = "vkCmdWriteTimestamp", CallingConvention = callingConvention)]
        internal static extern void vkCmdWriteTimestamp(IntPtr commandBuffer, PipelineStageFlags pipelineStage, UInt64 queryPool, UInt32 query);
        
        [DllImport(DllName, EntryPoint = "vkCmdCopyQueryPoolResults", CallingConvention = callingConvention)]
        internal static extern void vkCmdCopyQueryPoolResults(IntPtr commandBuffer, UInt64 queryPool, UInt32 firstQuery, UInt32 queryCount, UInt64 dstBuffer, DeviceSize dstOffset, DeviceSize stride, QueryResultFlags flags);
        
        [DllImport(DllName, EntryPoint = "vkCmdPushConstants", CallingConvention = callingConvention)]
        internal static extern void vkCmdPushConstants(IntPtr commandBuffer, UInt64 layout, ShaderStageFlags stageFlags, UInt32 offset, UInt32 size, IntPtr* values);
        ...
        internal static extern Result vkCreateAndroidSurfaceKHR(IntPtr instance, AndroidSurfaceCreateInfoKHR* createInfo, AllocationCallbacks* allocator, UInt64* surface);
        ...
        internal static extern Result vkGetDisplayPlaneSupportedDisplaysKHR(IntPtr physicalDevice, UInt32 planeIndex, UInt32* displayCount, UInt64* displays);
        
        [DllImport(DllName, EntryPoint = "vkGetDisplayModePropertiesKHR", CallingConvention = callingConvention)]
        internal static extern Result vkGetDisplayModePropertiesKHR(IntPtr physicalDevice, UInt64 display, UInt32* propertyCount, DisplayModePropertiesKHR* properties);
        
        [DllImport(DllName, EntryPoint = "vkCreateDisplayModeKHR", CallingConvention = callingConvention)]
        internal static extern Result vkCreateDisplayModeKHR(IntPtr physicalDevice, UInt64 display, DisplayModeCreateInfoKHR* createInfo, AllocationCallbacks* allocator, UInt64* mode);
        
        [DllImport(DllName, EntryPoint = "vkGetDisplayPlaneCapabilitiesKHR", CallingConvention = callingConvention)]
        internal static extern Result vkGetDisplayPlaneCapabilitiesKHR(IntPtr physicalDevice, UInt64 mode, UInt32 planeIndex, DisplayPlaneCapabilitiesKHR* capabilities);
        
        [DllImport(DllName, EntryPoint = "vkCreateDisplayPlaneSurfaceKHR", CallingConvention = callingConvention)]
        internal static extern Result vkCreateDisplayPlaneSurfaceKHR(IntPtr instance, DisplaySurfaceCreateInfoKHR* createInfo, AllocationCallbacks* allocator, UInt64* surface);
        
        [DllImport(DllName, EntryPoint = "vkCreateSharedSwapchainsKHR", CallingConvention = callingConvention)]
        internal static extern Result vkCreateSharedSwapchainsKHR(IntPtr device, UInt32 swapchainCount, SwapchainCreateInfoKHR* createInfos, AllocationCallbacks* allocator, UInt64* swapchains);
        ...
        internal static extern Result vkGetSwapchainImagesKHR(IntPtr device, UInt64 swapchain, UInt32* swapchainImageCount, UInt64* swapchainImages);
        
        [DllImport(DllName, EntryPoint = "vkAcquireNextImageKHR", CallingConvention = callingConvention)]
        internal static extern Result vkAcquireNextImageKHR(IntPtr device, UInt64 swapchain, UInt64 timeout, UInt64 semaphore, UInt64 fence, UInt32* imageIndex);
