...
namespace Vulkan
{
    unsafe public class PipelineDepthStencilStateCreateInfo
    {
        ...
        {
            NativePointer = (Interop.PipelineDepthStencilStateCreateInfo*)MemoryUtils.Allocate(typeof(Interop.PipelineDepthStencilStateCreateInfo));
        ...
        public void Free()
        {
            ...
            NativePointer = (Interop.PipelineDepthStencilStateCreateInfo*)IntPtr.Zero;
        }
    }
}
