...
namespace Vulkan
{
    unsafe public class Win32SurfaceCreateInfoKHR
    {
        ...
        {
            NativePointer = (Interop.Win32SurfaceCreateInfoKHR*)MemoryUtils.Allocate(typeof(Interop.Win32SurfaceCreateInfoKHR));
        ...
        public void Free()
        {
            ...
            NativePointer = (Interop.Win32SurfaceCreateInfoKHR*)IntPtr.Zero;
        }
    }
}
