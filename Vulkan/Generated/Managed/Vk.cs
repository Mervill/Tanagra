...
namespace Vulkan.Managed
{
    ...
    public unsafe static class Vk
    {
        ...
        public static PhysicalDevice[] EnumeratePhysicalDevices(Instance instance)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumeratePhysicalDevices), result);
            
            var arrayPhysicalDevice = stackalloc IntPtr[(Int32)listLength];
            result = vkEnumeratePhysicalDevices(instance.NativePointer, &listLength, arrayPhysicalDevice);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumeratePhysicalDevices), result);
        ...
        public static LayerProperties[] EnumerateInstanceLayerProperties()
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumerateInstanceLayerProperties), result);
            
            var resultSize = Marshal.SizeOf(typeof(Unmanaged.LayerProperties));
            var arrayLayerProperties = stackalloc Unmanaged.LayerProperties[(Int32)listLength];
            result = vkEnumerateInstanceLayerProperties(&listLength, arrayLayerProperties);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumerateInstanceLayerProperties), result);
            ...
            for(var x = 0; x < (Int32)listLength; x++)
            {
                ...
                MemUtil.Copy(new IntPtr(&arrayLayerProperties[x]), new IntPtr(item.NativePointer), resultSize);
                list[x] = item;
            }
        ...
        public static ExtensionProperties[] EnumerateInstanceExtensionProperties(String layerName)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumerateInstanceExtensionProperties), result);
            
            var resultSize = Marshal.SizeOf(typeof(Unmanaged.ExtensionProperties));
            var arrayExtensionProperties = stackalloc Unmanaged.ExtensionProperties[(Int32)listLength];
            result = vkEnumerateInstanceExtensionProperties(layerName, &listLength, arrayExtensionProperties);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumerateInstanceExtensionProperties), result);
            ...
            for(var x = 0; x < (Int32)listLength; x++)
            {
                ...
                MemUtil.Copy(new IntPtr(&arrayExtensionProperties[x]), new IntPtr(item.NativePointer), resultSize);
                list[x] = item;
            }
        ...
        public static LayerProperties[] EnumerateDeviceLayerProperties(PhysicalDevice physicalDevice)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumerateDeviceLayerProperties), result);
            
            var resultSize = Marshal.SizeOf(typeof(Unmanaged.LayerProperties));
            var arrayLayerProperties = stackalloc Unmanaged.LayerProperties[(Int32)listLength];
            result = vkEnumerateDeviceLayerProperties(physicalDevice.NativePointer, &listLength, arrayLayerProperties);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumerateDeviceLayerProperties), result);
        ...
        public static ExtensionProperties[] EnumerateDeviceExtensionProperties(PhysicalDevice physicalDevice, String layerName = default(String))
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumerateDeviceExtensionProperties), result);
            
            var resultSize = Marshal.SizeOf(typeof(Unmanaged.ExtensionProperties));
            var arrayExtensionProperties = stackalloc Unmanaged.ExtensionProperties[(Int32)listLength];
            result = vkEnumerateDeviceExtensionProperties(physicalDevice.NativePointer, layerName, &listLength, arrayExtensionProperties);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkEnumerateDeviceExtensionProperties), result);
        ...
        public static void QueueSubmit(Queue queue, SubmitInfo[] submits, Fence fence = default(Fence))
        {
            ...
            var _submitsPtr = stackalloc Unmanaged.SubmitInfo[(Int32)submitCount];
            if(submits != null)
        ...
        public static void FlushMappedMemoryRanges(Device device, params MappedMemoryRange[] memoryRanges)
        {
            ...
            var _memoryRangesPtr = stackalloc Unmanaged.MappedMemoryRange[(Int32)memoryRangeCount];
        ...
        public static void QueueBindSparse(Queue queue, BindSparseInfo[] bindInfo, Fence fence = default(Fence))
        {
            ...
            var _bindInfoPtr = stackalloc Unmanaged.BindSparseInfo[(Int32)bindInfoCount];
            if(bindInfo != null)
        ...
        public static void ResetFences(Device device, params Fence[] fences)
        {
            ...
            var _fencesPtr = stackalloc UInt64[(Int32)fenceCount];
            if(fences != null)
        ...
        /// <param name="flags">Optional</param>
        public static Byte[] GetQueryPoolResults(Device device, QueryPool queryPool, UInt32 firstQuery, UInt32 queryCount, Size dataSize, DeviceSize stride, QueryResultFlags flags = default(QueryResultFlags))
        {
            var listLength = dataSize;
            Result result;
            
            var arrayByte = stackalloc Byte[(Int32)listLength];
            result = vkGetQueryPoolResults(device.NativePointer, queryPool.NativePointer, firstQuery, queryCount, listLength, arrayByte, stride, flags);
        ...
        public static Byte[] GetPipelineCacheData(Device device, PipelineCache pipelineCache)
        {
            ...
            var arrayByte = stackalloc Byte[(Int32)listLength];
            result = vkGetPipelineCacheData(device.NativePointer, pipelineCache.NativePointer, &listLength, arrayByte);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetPipelineCacheData), result);
        ...
        public static void MergePipelineCaches(Device device, PipelineCache dstCache, params PipelineCache[] srcCaches)
        {
            ...
            var _srcCachesPtr = stackalloc UInt64[(Int32)srcCacheCount];
            if(srcCaches != null)
        ...
        public static Pipeline[] CreateGraphicsPipelines(Device device, PipelineCache pipelineCache, GraphicsPipelineCreateInfo[] createInfos, AllocationCallbacks allocator = default(AllocationCallbacks))
        {
            ...
            var _createInfosPtr = stackalloc Unmanaged.GraphicsPipelineCreateInfo[(Int32)createInfoCount];
            if(createInfos != null)
            ...
            var list = new Pipeline[(Int32)listLength];
            for(var x = 0; x < (Int32)listLength; x++)
            {
        ...
        {
            var createInfoCount = (createInfos != null) ? (UInt32)createInfos.Length : 0;
            var _createInfosPtr = stackalloc Unmanaged.ComputePipelineCreateInfo[(Int32)createInfoCount];
            if(createInfos != null)
                for(var x = 0; x < createInfoCount; x++)
                    _createInfosPtr[x] = *createInfos[x].NativePointer;
        ...
        public static DescriptorSet[] AllocateDescriptorSets(Device device, DescriptorSetAllocateInfo allocateInfo)
        {
            ...
            var list = new DescriptorSet[(Int32)listLength];
            for(var x = 0; x < (Int32)listLength; x++)
            {
        ...
        public static void FreeDescriptorSets(Device device, DescriptorPool descriptorPool, params DescriptorSet[] descriptorSets)
        {
            ...
            var _descriptorSetsPtr = stackalloc UInt64[(Int32)descriptorSetCount];
        ...
        public static void UpdateDescriptorSets(Device device, WriteDescriptorSet[] descriptorWrites, params CopyDescriptorSet[] descriptorCopies)
        {
            ...
            var _descriptorWritesPtr = stackalloc Unmanaged.WriteDescriptorSet[(Int32)descriptorWriteCount];
            ...
            var _descriptorCopiesPtr = stackalloc Unmanaged.CopyDescriptorSet[(Int32)descriptorCopyCount];
        ...
        public static CommandBuffer[] AllocateCommandBuffers(Device device, CommandBufferAllocateInfo allocateInfo)
        {
            ...
            var list = new CommandBuffer[(Int32)listLength];
            for(var x = 0; x < (Int32)listLength; x++)
            {
        ...
        public static void FreeCommandBuffers(Device device, CommandPool commandPool, params CommandBuffer[] commandBuffers)
        {
            ...
            var _commandBuffersPtr = stackalloc IntPtr[(Int32)commandBufferCount];
        ...
        public static void CmdSetViewport(CommandBuffer commandBuffer, UInt32 firstViewport, params Viewport[] viewports)
        {
            ...
            var _viewportsPtr = stackalloc Viewport[(Int32)viewportCount];
            if(viewports != null)
        ...
        public static void CmdSetScissor(CommandBuffer commandBuffer, UInt32 firstScissor, params Rect2D[] scissors)
        {
            ...
            var _scissorsPtr = stackalloc Rect2D[(Int32)scissorCount];
            if(scissors != null)
        ...
        public static void CmdBindDescriptorSets(CommandBuffer commandBuffer, PipelineBindPoint pipelineBindPoint, PipelineLayout layout, UInt32 firstSet, DescriptorSet[] descriptorSets, params UInt32[] dynamicOffsets)
        {
            ...
            var _dynamicOffsetsPtr = stackalloc UInt32[(Int32)dynamicOffsetCount];
        ...
        public static void CmdBindVertexBuffers(CommandBuffer commandBuffer, UInt32 firstBinding, Buffer[] buffers, params DeviceSize[] offsets)
        {
            ...
            var _buffersPtr = stackalloc UInt64[(Int32)bindingCount];
            if(buffers != null)
                for(var x = 0; x < bindingCount; x++)
                    _buffersPtr[x] = buffers[x].NativePointer;
            
            var _offsetsPtr = stackalloc DeviceSize[(Int32)bindingCount];
            if(offsets != null)
                for(var x = 0; x < bindingCount; x++)
        ...
        public static void CmdCopyBuffer(CommandBuffer commandBuffer, Buffer srcBuffer, Buffer dstBuffer, params BufferCopy[] regions)
        {
            ...
            var _regionsPtr = stackalloc BufferCopy[(Int32)regionCount];
            if(regions != null)
        ...
        {
            var regionCount = (regions != null) ? (UInt32)regions.Length : 0;
            var _regionsPtr = stackalloc ImageCopy[(Int32)regionCount];
            if(regions != null)
                for(var x = 0; x < regionCount; x++)
                    _regionsPtr[x] = regions[x];
        ...
        {
            var regionCount = (regions != null) ? (UInt32)regions.Length : 0;
            var _regionsPtr = stackalloc ImageBlit[(Int32)regionCount];
            if(regions != null)
                for(var x = 0; x < regionCount; x++)
                    _regionsPtr[x] = regions[x];
        ...
        {
            var regionCount = (regions != null) ? (UInt32)regions.Length : 0;
            var _regionsPtr = stackalloc BufferImageCopy[(Int32)regionCount];
            if(regions != null)
                for(var x = 0; x < regionCount; x++)
                    _regionsPtr[x] = regions[x];
        ...
        public static void CmdClearColorImage(CommandBuffer commandBuffer, Image image, ImageLayout imageLayout, ClearColorValue color, params ImageSubresourceRange[] ranges)
        {
            ...
            var _rangesPtr = stackalloc ImageSubresourceRange[(Int32)rangeCount];
            if(ranges != null)
        ...
        public static void CmdClearAttachments(CommandBuffer commandBuffer, ClearAttachment[] attachments, params ClearRect[] rects)
        {
            ...
            var _attachmentsPtr = stackalloc ClearAttachment[(Int32)attachmentCount];
            if(attachments != null)
                for(var x = 0; x < attachmentCount; x++)
                    _attachmentsPtr[x] = attachments[x];
            
            var rectCount = (rects != null) ? (UInt32)rects.Length : 0;
            var _rectsPtr = stackalloc ClearRect[(Int32)rectCount];
            if(rects != null)
        ...
        {
            var regionCount = (regions != null) ? (UInt32)regions.Length : 0;
            var _regionsPtr = stackalloc ImageResolve[(Int32)regionCount];
            if(regions != null)
                for(var x = 0; x < regionCount; x++)
                    _regionsPtr[x] = regions[x];
        ...
        public static void CmdWaitEvents(CommandBuffer commandBuffer, Event[] events, PipelineStageFlags srcStageMask, PipelineStageFlags dstStageMask, MemoryBarrier[] memoryBarriers, BufferMemoryBarrier[] bufferMemoryBarriers, params ImageMemoryBarrier[] imageMemoryBarriers)
        {
            ...
            var _eventsPtr = stackalloc UInt64[(Int32)eventCount];
            if(events != null)
            ...
            var _memoryBarriersPtr = stackalloc Unmanaged.MemoryBarrier[(Int32)memoryBarrierCount];
            ...
            var _bufferMemoryBarriersPtr = stackalloc Unmanaged.BufferMemoryBarrier[(Int32)bufferMemoryBarrierCount];
            ...
            var _imageMemoryBarriersPtr = stackalloc Unmanaged.ImageMemoryBarrier[(Int32)imageMemoryBarrierCount];
        ...
        public static DisplayPropertiesKHR[] GetPhysicalDeviceDisplayPropertiesKHR(PhysicalDevice physicalDevice)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetPhysicalDeviceDisplayPropertiesKHR), result);
            
            var resultSize = Marshal.SizeOf(typeof(Unmanaged.DisplayPropertiesKHR));
            var arrayDisplayPropertiesKHR = stackalloc Unmanaged.DisplayPropertiesKHR[(Int32)listLength];
            result = vkGetPhysicalDeviceDisplayPropertiesKHR(physicalDevice.NativePointer, &listLength, arrayDisplayPropertiesKHR);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetPhysicalDeviceDisplayPropertiesKHR), result);
            ...
            for(var x = 0; x < (Int32)listLength; x++)
            {
                ...
                MemUtil.Copy(new IntPtr(&arrayDisplayPropertiesKHR[x]), new IntPtr(item.NativePointer), resultSize);
                list[x] = item;
            }
        ...
        public static DisplayPlanePropertiesKHR[] GetPhysicalDeviceDisplayPlanePropertiesKHR(PhysicalDevice physicalDevice)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetPhysicalDeviceDisplayPlanePropertiesKHR), result);
            
            var resultSize = Marshal.SizeOf(typeof(Unmanaged.DisplayPlanePropertiesKHR));
            var arrayDisplayPlanePropertiesKHR = stackalloc Unmanaged.DisplayPlanePropertiesKHR[(Int32)listLength];
            result = vkGetPhysicalDeviceDisplayPlanePropertiesKHR(physicalDevice.NativePointer, &listLength, arrayDisplayPlanePropertiesKHR);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetPhysicalDeviceDisplayPlanePropertiesKHR), result);
            ...
            for(var x = 0; x < (Int32)listLength; x++)
            {
                ...
                MemUtil.Copy(new IntPtr(&arrayDisplayPlanePropertiesKHR[x]), new IntPtr(item.NativePointer), resultSize);
                list[x] = item;
            }
        ...
        public static DisplayKHR[] GetDisplayPlaneSupportedDisplaysKHR(PhysicalDevice physicalDevice, UInt32 planeIndex)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetDisplayPlaneSupportedDisplaysKHR), result);
            
            var arrayDisplayKHR = stackalloc UInt64[(Int32)listLength];
            result = vkGetDisplayPlaneSupportedDisplaysKHR(physicalDevice.NativePointer, planeIndex, &listLength, arrayDisplayKHR);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetDisplayPlaneSupportedDisplaysKHR), result);
        ...
        public static DisplayModePropertiesKHR[] GetDisplayModePropertiesKHR(PhysicalDevice physicalDevice, DisplayKHR display)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetDisplayModePropertiesKHR), result);
            
            var resultSize = Marshal.SizeOf(typeof(Unmanaged.DisplayModePropertiesKHR));
            var arrayDisplayModePropertiesKHR = stackalloc Unmanaged.DisplayModePropertiesKHR[(Int32)listLength];
            result = vkGetDisplayModePropertiesKHR(physicalDevice.NativePointer, display.NativePointer, &listLength, arrayDisplayModePropertiesKHR);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetDisplayModePropertiesKHR), result);
            ...
            for(var x = 0; x < (Int32)listLength; x++)
            {
                ...
                MemUtil.Copy(new IntPtr(&arrayDisplayModePropertiesKHR[x]), new IntPtr(item.NativePointer), resultSize);
                list[x] = item;
            }
        ...
        public static SwapchainKHR[] CreateSharedSwapchainsKHR(Device device, SwapchainCreateInfoKHR[] createInfos, AllocationCallbacks allocator = default(AllocationCallbacks))
        {
            ...
            var _createInfosPtr = stackalloc Unmanaged.SwapchainCreateInfoKHR[(Int32)swapchainCount];
            if(createInfos != null)
            ...
            var list = new SwapchainKHR[(Int32)listLength];
            for(var x = 0; x < (Int32)listLength; x++)
            {
        ...
        public static IntPtr GetPhysicalDeviceMirPresentationSupportKHR(PhysicalDevice physicalDevice, UInt32 queueFamilyIndex)
        {
            ...
            var result = vkGetPhysicalDeviceMirPresentationSupportKHR(physicalDevice.NativePointer, queueFamilyIndex, &connection);
            return connection;
        }
        ...
        public static SurfaceFormatKHR[] GetPhysicalDeviceSurfaceFormatsKHR(PhysicalDevice physicalDevice, SurfaceKHR surface)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetPhysicalDeviceSurfaceFormatsKHR), result);
            
            var arraySurfaceFormatKHR = stackalloc SurfaceFormatKHR[(Int32)listLength];
            result = vkGetPhysicalDeviceSurfaceFormatsKHR(physicalDevice.NativePointer, surface.NativePointer, &listLength, arraySurfaceFormatKHR);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetPhysicalDeviceSurfaceFormatsKHR), result);
        ...
        public static PresentModeKHR[] GetPhysicalDeviceSurfacePresentModesKHR(PhysicalDevice physicalDevice, SurfaceKHR surface)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetPhysicalDeviceSurfacePresentModesKHR), result);
            
            var arrayPresentModeKHR = stackalloc PresentModeKHR[(Int32)listLength];
            result = vkGetPhysicalDeviceSurfacePresentModesKHR(physicalDevice.NativePointer, surface.NativePointer, &listLength, arrayPresentModeKHR);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetPhysicalDeviceSurfacePresentModesKHR), result);
        ...
        public static Image[] GetSwapchainImagesKHR(Device device, SwapchainKHR swapchain)
        {
            ...
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetSwapchainImagesKHR), result);
            
            var arrayImage = stackalloc UInt64[(Int32)listLength];
            result = vkGetSwapchainImagesKHR(device.NativePointer, swapchain.NativePointer, &listLength, arrayImage);
            if(result != Result.Success)
                throw new VulkanResultException(nameof(vkGetSwapchainImagesKHR), result);
        ...
        public static IntPtr GetPhysicalDeviceWaylandPresentationSupportKHR(PhysicalDevice physicalDevice, UInt32 queueFamilyIndex)
        {
            ...
            var result = vkGetPhysicalDeviceWaylandPresentationSupportKHR(physicalDevice.NativePointer, queueFamilyIndex, &display);
            return display;
        }
        ...
        public static IntPtr GetPhysicalDeviceXlibPresentationSupportKHR(PhysicalDevice physicalDevice, UInt32 queueFamilyIndex, IntPtr visualID)
        {
            var dpy = new IntPtr();
        ...
        public static IntPtr GetPhysicalDeviceXcbPresentationSupportKHR(PhysicalDevice physicalDevice, UInt32 queueFamilyIndex, IntPtr visual_id)
        {
            var connection = new IntPtr();
