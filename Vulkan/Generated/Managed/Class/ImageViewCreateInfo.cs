...
namespace Vulkan.Managed
{
    unsafe public class ImageViewCreateInfo : IDisposable
    {
        ...
        {
            NativePointer = (Unmanaged.ImageViewCreateInfo*)MemoryUtils.Allocate(typeof(Unmanaged.ImageViewCreateInfo));
        ...
        public void Dispose()
        {
            ...
            NativePointer = (Unmanaged.ImageViewCreateInfo*)IntPtr.Zero;
            GC.SuppressFinalize(this);
        }
        
        ~ImageViewCreateInfo()
        {
            if(NativePointer != (Unmanaged.ImageViewCreateInfo*)IntPtr.Zero)
            {
                MemoryUtils.Free((IntPtr)NativePointer);
                NativePointer = (Unmanaged.ImageViewCreateInfo*)IntPtr.Zero;
            }
