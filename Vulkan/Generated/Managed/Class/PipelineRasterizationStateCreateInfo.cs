...
{
    /// <summary>
    /// [<see cref="IExtensible"/>: VkPipelineRasterizationStateRasterizationOrderAMD]
    /// </summary>
    unsafe public class PipelineRasterizationStateCreateInfo : IDisposable
    {
        ...
        {
            NativePointer = (Unmanaged.PipelineRasterizationStateCreateInfo*)MemUtil.Alloc(typeof(Unmanaged.PipelineRasterizationStateCreateInfo));
